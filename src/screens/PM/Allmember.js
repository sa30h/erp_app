  ...
  renderItem={({item})=>{return(
   ...
   <DataTable>
      ...
      <DataTable.Row>
        ...
        <DataTable.Cell numeric><Text style={{fontSize:17}}>{accountlist.find(x=>x.id==item.team_member)?accountlist.find(x=>x.id==item.team_member).email:"..."}</Text></DataTable.Cell>
      </DataTable.Row> 
